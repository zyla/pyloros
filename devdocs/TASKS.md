...
- [x] Add binary-level integration tests with curl
  - [x] Config fields: upstream_override_port, upstream_tls_ca
  - [x] Fix port logging to use actual bound address (not config address)
  - [x] Wire new config fields in main.rs (+ CryptoProvider fix, stderr logging)
  - [x] Binary tests: allowed GET 200, blocked 451, generate-ca PEM validation
